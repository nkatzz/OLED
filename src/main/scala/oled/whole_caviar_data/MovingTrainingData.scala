    ...
    val training = fold match {
      ...
      case 10 =>
        randomOrder match {
          ...
          case _ =>
            List(Interval("moving",2480,5760), Interval("moving",860720,868440), Interval("moving",24400,27320), Interval("moving",427280,460600), Interval("moving",896880,909480), Interval("moving",910360,917400), Interval("moving",464120,547400), Interval("moving",852720,860680), Interval("moving",648080,688040), Interval("moving",307280,347240), Interval("moving",387280,427240), Interval("moving",227280,267240), Interval("moving",107280,147240), Interval("moving",786200,791880), Interval("moving",680,2520), Interval("moving",800400,814880), Interval("moving",147280,187240), Interval("moving",5720,24440), Interval("moving",1069360,1077280), Interval("moving",547360,559240), Interval("moving",728080,768040), Interval("moving",1053360,1061320), Interval("moving",187280,227240), Interval("moving",27280,67240), Interval("moving",1037360,1045320), Interval("moving",565760,568120), Interval("moving",267280,307240), Interval("moving",1061360,1069320), Interval("moving",797080,800440), Interval("moving",829400,841280), Interval("moving",347280,387240), Interval("moving",559200,565800), Interval("moving",688080,728040), Interval("moving",568080,608040), Interval("moving",1045360,1053320), Interval("moving",909440,910400), Interval("moving",791840,797120), Interval("moving",768080,786200), Interval("moving",814840,829440), Interval("moving",460600,464160), Interval("moving",957360,997320), Interval("moving",608080,648040), Interval("moving",844720,852680), Interval("moving",67280,107240), Interval("moving",917360,957320), Interval("moving",841240,844760))
        }
