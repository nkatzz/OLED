...
*/
  ...
  val wholeCAVIARForTraining = {
    new TrainingSet(trainingSet = allPosIntervals++allNegIntervals, testingSet = allPosIntervals++allNegIntervals)
  }
  ...
  */
  ...
  val wholeCAVIAR1 = {
    ...
    new TrainingSet(trainingSet = List(allPosIntervals.head) ++ Random.shuffle(allPosIntervals++allNegIntervals), testingSet = List(Interval("meeting",680,1077680)))
