...
*/
  ...
  def getMovingTrainingSets() = {
    val intervals = all.utils.CaviarUtils.getPositiveNegativeIntervals(GlobalValues.fromDB, "moving")
  ...
  def getMeetingTrainingSets() = {
    val intervals = all.utils.CaviarUtils.getPositiveNegativeIntervals(GlobalValues.fromDB, "meeting")
