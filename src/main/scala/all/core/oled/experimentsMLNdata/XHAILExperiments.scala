...
import all.core.Xhail._
import all.globalValues.GlobalValues
import all.structures.{Literal, Theory, Clause}
import all.structures.Examples.Example
import all.utils._
import jep.Jep
import all.core.Core.glvalues
...
object XHAILExperiments extends LazyLogging {
  ...
  def main(args: Array[String])= {
    ...
    val testSet =
      dataset.asInstanceOf[all.core.oled.experimentsMLNdata.MLNDataHandler.TrainingSet].testingData.toIterator
